...
//go:generate minimock -i github.com/mchekalov/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
func (mmDelete *mChatServiceMockDelete) Expect(ctx context.Context, id *model.ChatDelete) *mChatServiceMockDelete {
...
func (mmDelete *mChatServiceMockDelete) Inspect(f func(ctx context.Context, id *model.ChatDelete)) *mChatServiceMockDelete {
...
func (mmDelete *mChatServiceMockDelete) Set(f func(ctx context.Context, id *model.ChatDelete) (err error)) *ChatServiceMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mChatServiceMockDelete) When(ctx context.Context, id *model.ChatDelete) *ChatServiceMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("ChatServiceMock.Delete mock is already set by Set")
	}
...
func (mmDelete *ChatServiceMock) Delete(ctx context.Context, id *model.ChatDelete) (err error) {
